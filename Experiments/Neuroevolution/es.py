...
class SimpleGA:
  ...
  def ask(self):
    ...
    solutions = []
    ####
    mutation_range = self.popsize

    mutation_range -= self.elite_popsize
    for index in range(self.elite_popsize):
        solutions.append(self.elite_params[index])
    ####
    ...
    for i in range(self.mutation_range): # new for loop
